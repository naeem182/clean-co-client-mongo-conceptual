...
import cleanermanImage from '../../assets/cleanerman.jpg'
...
const Banner = () => {
    return (
        <div className="w-full m-auto max-w-[1200px]">
            ...
            <div className="flex pb-32 pt-1 gap-16">
                ...
                <div className="h-[600px] w-full bg-green-500 flex-1 rounded-xl overflow-hidden ">
                    <img
                        src={cleanermanImage}
                        alt="landing"
